...
var SongVerse = function SongVerse(props) {
  return __jsx("div", {
    ...
    __self: this
  }, "Verse"), props.verse.map(function (value, index) {
...
var SongLine = function SongLine(props) {
  return __jsx("div", {
    ...
    __self: this
  }, "line", props.line.map(function (map, index) {})), console.log(props.line));
};
...
//# sourceMappingURL=song.js.2ecf33a973d308792ca8.hot-update.js.map